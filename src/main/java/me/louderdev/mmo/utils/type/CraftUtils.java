...
public class CraftUtils {
    ...
    public static void handleCraft(Player player, User user, String nameSpacedId) {
        Level lastestLevel = user.getLastestLevel();

        if(lastestLevel != null && lastestLevel.getActionType() == ActionType.CRAFTING && handleAddExp(player, lastestLevel, nameSpacedId)) return;
    ...
    public static boolean canCraft(Player player, User user, String nameSpacedId) {
